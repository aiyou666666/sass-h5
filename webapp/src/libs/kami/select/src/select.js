 ...
 * @extends Widget
 * @category primary
 * @demo http://ued.qunar.com/mobile/kami/demo/src/html/select/index.html
 */
    ...
    initProp: function () {
        ...
        for (var i = 0; i < this.sectionItemListDom.length; i++) {
            (function (dom, index) {
                ...
                widget._widgetMap[_getChildCtrlName(widget.datasource[index].key)] = new SelectItemList(options);
