 ...
 * @extends List
 * @category primary
 * @demo http://ued.qunar.com/mobile/kami/demo/src/html/grouplist/index.html
 */
...
var Grouplist = List.extend({
     ...
     * @property {Boolean} infinite 是否开启无限滚动模式，默认为false，false是append节点，true会有固定个数的节点，滚动的时候移动节点和更新数据
     ...
     *
     * @template itemTpl
     * 列表选项的模板，该模板自定义时，建议拷贝后修改，itemTpl的模板
     * 必须含有data-role="list-item"和data-role="title"两个属性，
     * 其他模板的变量需要与数据一致
     * @memberOf Grouplist
     * @path ./tpl/grouplist-item.string
     * 
     */
    ...
    _infiniteHandler: function() {
        ...
        this._infiniteElements = this._itemWrap.find('[data-role="list-item"]').concat(this._itemWrap.find('[data-role="title"]'));
