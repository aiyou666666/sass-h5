 ...
 * @extends Widget
 * @category business
 * @demo http://ued.qunar.com/mobile/kami/demo/src/html/searchlist/index.html
 */

var $ = require('../../util/index.js');
var Widget = require('../../core/index.js');
var Suggest = require('../../suggest/index.js');
var Grouplist = require('../../grouplist/index.js');
...
var Searchlist = Widget.extend({
     ...
     * 列表选项的模板，该模板自定义时，resultListTpl的模板
     * data-role="scroller" 指组件的滚动容器,
     ...
     * 列表选项的模板，该模板自定义时，resultItemTpl的模板
    ...
    initUI: function() {
        ...
        this._suggest = this._widgetMap['suggest'] = new Suggest({
            ...
            nodataTpl: this.get('nodataTpl'),
            enableNoDataTpl: this.get('enableNoDataTpl'),
            onSelectFilterItem: function (data) {
