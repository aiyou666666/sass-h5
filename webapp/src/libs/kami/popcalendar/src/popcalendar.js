 ...
 * @extends Widget
 * @category business
 * @demo http://ued.qunar.com/mobile/kami/demo/src/html/popcalendar/index.html
 */
...
var PopCalendar = Widget.extend({
     ...
     * @property {Number} duration 弹出层弹出且启用动画效果时，动画持续秒数
    ...
    _initUi: function () {
        ...
        var dialog = this._widgetMap['dialog'] = new Dialog({
            ...
            extraClass: this.get('extraClass') ? this.get('extraClass') : '',
            onok: function () {
        ...
        var calendar = this._widgetMap['calendar'] = new Calendar({
            ...
            now: widget.get('now'),
            frmateKey:widget.get('frmateKey'),
