 ...
 * @extends Widget
 * @category primary
 * @demo http://ued.qunar.com/mobile/kami/demo/src/html/switchable/index.html
 */
...
var Switchable = Widget.extend({
    ...
    _testOption: function () {
        ...
        !parseInt(this.get('delay'), 10) && console.warn('delay必须输入数字，单位为毫秒');
    ...
    parseTemplate: function (tpl) {
        ...
        if (this._aniStyle.handleData) {
            dataSet = this._aniStyle.handleData(data);
        }
